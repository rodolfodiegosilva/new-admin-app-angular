...
@Component({
  ...
  styleUrls: ['./test-create-page.component.css'],
  providers: [MessageService, DefaultDataService, ManageuserService, QuestiondetailedviewService, ClassificationsService, Ng4LoadingSpinnerService, TestcreateService],
})
export class TestCreatePageComponent implements OnInit {
  ...
  createTest(ctForm: NgForm) {
    //return false;
    this.spinnerService.show();
    this._testcreateService.createTest(ctForm.value).subscribe(
      data => {
        {
        ...
        this.test_id = this.response.test_id;
        ...
        this.alertmsgSucc = 'Test created Successfully';
        this.createTimelineForTest();
        ...
        for (let atmpGrd of data.attemptedQnsCount) {
          if (atmpGrd.question_grade == 1) {
            this.attmptdLabelA = atmpGrd.count;
          }
          if (atmpGrd.question_grade == 2) {
            this.attmptdLabelB = atmpGrd.count;
          }
          if (atmpGrd.question_grade == 3) {
            this.attmptdLabelC = atmpGrd.count;
          }
          if (atmpGrd.question_grade == 4) {
            this.attmptdLabelD = atmpGrd.count;
          }
          // if(atmpGrd.question_grade==5){
          //   this.attmptdLabelE = atmpGrd.count;            
          // }
        }
        for (let crtGrd of data.crrctAnsQnsCount) {
          ...
          // if(crtGrd.question_grade==5){
          //   this.crtGrdLabelE = crtGrd.count;            
          // }
        }
        for (let icrtGrd of data.incrrctAnsQnsCount) {
          ...
          // if(icrtGrd.question_grade==5){
          //   this.incrtGrdLabelE = icrtGrd.count;            
          // }
        }
        this.showCharts();
        this.showQuestions();
  ...
  createTimelineForTest() {
    ...
    this._testcreateService.createTimelineForTest(this.data).subscribe(
      data => {
  ...
  rescheduleTestdates() {
    ...
    this._testcreateService.rescheduleTestdates(this.requData).subscribe(
      data => {
        { this.response = data.response; }
        if (data.response == 1) {
          this.alertmsgClass = 'success';
  ...
  AssignTesttoUser1() {
    ...
    this._testcreateService.AssignTesttoUser2(this.assigndata).subscribe(
      data => {
        { this.response = data.response; }
        this.alertmsgClass = 'success';
        this.msgSummery = 'Success';
  ...
  unAssignTestforUser() {
    ...
    this._testcreateService.unAssigntestforUser(this.unassigndata).subscribe(
      data => {
        { this.response = data.response }
        this.alertmsgClass = 'success';
        this.msgSummery = 'Success';
  ...
  creatQuestionPaper(data: any) {
    ...
    this._testcreateService.creatQuestionPaper(data).subscribe(
      data => {
        { this.response = data; }
        this.alertmsgClass = 'success';
        this.msgSummery = 'Success';
  ...
  AssignQnsforTest() {
    ...
    this._testcreateService.AssignQnsforTest(this.assigndata).subscribe(
      data => {
        { this.response = data.response }
        if (data.response == 1) {
          this.assignedQnsNum++;
          // this.alertmsgClass = 'success';
          // this.msgSummery = 'Success';
          // this.alertmsgSucc = 'Question no. ' + this.selectedQnid + ' is assigned to test no. ' + this.test_id + ' Successfully!';
          // this.showSuccess();
          if (this.testtype_id == 3) {
            this.getAssignedUserstoTest();
            this.showQuestions();
          ...
          this.alertmsgClass = 'error';
          this.msgSummery = 'Error';
          this.alertmsgSucc = 'Question no. ' + this.selectedQnid + ' is already assigned to test no. ' + this.test_id + '. Please try with another!';
          this.showSuccess();
        }
  ...
  unAssignQnsforTest() {
    ...
    this._testcreateService.unAssignQnsforTest(this.assigndata).subscribe(
      data => {
        { this.response = data.response }
        ...
        if (data.response == 1) {
          ...
          this.alertmsgClass = 'success';
          this.msgSummery = 'Success';
          this.alertmsgSucc = 'Question no. ' + this.selectedQnid + ' is unassigned for the test no. ' + this.test_id + ' Successfully!';
          this.showSuccess();

        } else {
          this.alertmsgClass = 'error';
          this.msgSummery = 'Error';
          this.alertmsgSucc = 'Question no. ' + this.selectedQnid + ' is not assigned to test no. ' + this.test_id + '. Please try with another!';
          this.showSuccess();
        }
      },
      error => { }
  ...
  getAssignedUserstoTest() {
    ...
    this._testcreateService.getAssignedUserstoTest(this.assigndata).subscribe(
      data => {
  ...
  getAssignedQuestionsforTest() {
    ...
    this.assignedQnsIds = [];
    this._testcreateService.getAssignedQuestionsforTest(getData).subscribe(
      data => {
  ...
  updateTestSpec(t_id: any, val: any, col: any, field: any) {
    ...
    this._testcreateService.updateTestSpec(this.update).subscribe(
      data => {
        { this.response = data.response; }
        this[field] = false;
        this[field + '_show'] = false;
  ...
  updateTestSpecResAdmin(t_id: any, val: any, col: any, field: any) {
    ...
    //return false;
    this._testcreateService.updateTestSpec(this.data).subscribe(
      data => {
        { this.response = data.response; }
        this[field] = false;
        this[field + '_show'] = false;
    ...
    this._testcreateService.unAssignQnsforTest(this.assigndata).subscribe(
      data => {
        ...
        if (data.response == 1) {
          ...
          this.alertmsgClass = 'success';
          this.msgSummery = 'Success';
          this.alertmsgSucc = 'Question no. ' + this.removeQuestionIds + ' is unassigned for the test no. ' + this.test_id + ' Successfully!';
          this.showSuccess();
          this.showQuestions();
          ...
          this.alertmsgClass = 'error';
          this.msgSummery = 'Error';
          this.alertmsgSucc = 'Question no. ' + this.removeQuestionIds + ' is not assigned to test no. ' + this.test_id + '. Please try with another!';
          this.showSuccess();
        }
      },
      error => { }
  ...
  getTotalAvailabaleQnsGradewise() {
    ...
    if (this.selectedlessonList.length > 0 && this.country_id && this.course_value
      && this.class_value && this.subject_values && this.course_value) {
      this.getAllLessons();
      this._testcreateService.getTotalAvailabaleQnsGradewise(this.data).subscribe(
        data => {
          this.showAvailableQns = true;
          { this.getQnsGrdWise = data.getQnsGrdWise; }
          if (this.getQnsGrdWise.length > 0) {
            for (let qnsGrd of data.getQnsGrdWise) {
              if (qnsGrd.question_grade == 1) {
                this.alqLabelA = qnsGrd.count;
              }
  ...
  getAssignedUserstoThisQns(qnsId: number) {
    ...
    this._testcreateService.getAssignedUserstoThisQns(this.data).subscribe(
      data => {
  ...
  declareResult() {
    ...
    this._testcreateService.declareResult(this.requData).subscribe(
      data => {
        { this.response = data.response; }
        if (data.response != 2) {
