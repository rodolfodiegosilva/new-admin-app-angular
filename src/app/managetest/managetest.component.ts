...
this.ownersList = [
  ...
  ngOnInit() {
   ...
   //  console.log('File Url'+this.filesUrl);
    ...
    .subscribe(params => { this.test_id = params.get('test_id'); });
    this.getSingleTest();
  ...
  getSingleTest(){
    ...
    this._testcreateService.getSingleTest(this.data).subscribe(
        data => {
          ...
          this.getAssignedUserstoTest();
          this.testtype_id  = this.testDetails[0].test_type;
          this.class_ids  = this.testDetails[0].classf_class_id;
          this.country_ids  = this.testDetails[0].classf_country_id;
          this.course_values  = this.testDetails[0].classf_course_id;
          this.subject_ids  = this.testDetails[0].classf_subject_id;
          this.seltddltList  = this.testDetails[0].lesson_id;
          this.total_ques = this.testDetails[0].test_total_ques;
          this.selectedlessonList = this.testDetails[0].lesson_id;
